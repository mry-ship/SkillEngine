...
namespace SkillEngine {
    public class BaseEdgeDragHelper : EdgeDragHelper {
        ...
        protected Dictionary<BaseNodeView, List<BasePortView>> compatiblePorts =
            new Dictionary<BaseNodeView, List<BasePortView>>();
        ...
        protected virtual BaseEdgeView CreateEdgeView() {
        ...
        public override bool HandleMouseDown(MouseDownEvent evt) {
            // Debug.Log("<color=yellow>--- BaseEdgeDragHelper.HandleMouseDown ---</color>");
            ...
            foreach (BasePortView port in graphView.GetCompatiblePorts(draggedPort, nodeAdapter)) {
                compatiblePorts.TryGetValue(port.owner, out var portList);
                if (portList == null)
                    portList = compatiblePorts[port.owner] = new List<BasePortView>();
                portList.Add(port);
            }
        ...
        public override void HandleMouseUp(MouseUpEvent evt) {
            // Debug.Log("<color=yellow>--- BaseEdgeDragHelper.HandleMouseUp ---</color>");
        ...
        public override void Reset(bool didConnect = false) {
            // Debug.Log("<color=yellow>--- BaseEdgeDragHelper.Reset ---</color>");
            ...
            if ((ghostEdge != null) && (graphView != null)) {
                var pv = ghostEdge.input as BasePortView;
        ...
        Rect GetPortBounds(BaseNodeView nodeView, int index, List<BasePortView> portList) {
