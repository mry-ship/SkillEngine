...
namespace SkillEngine
{
    public static class NodeProvider
    {
        ...
        static Dictionary<BaseGraph, NodeDescriptions> specificNodeDescriptions =
            new Dictionary<BaseGraph, NodeDescriptions>();
            ...
            BaseGraph graph = null)
        {
            ...
            foreach (var p in node.inputPorts.Values.ToList())
                AddPort(p, true);
            foreach (var p in node.outputPorts.Values.ToList())
                AddPort(p, false);
        ...
        public static IEnumerable<PortDescription> GetEdgeCreationNodeMenuEntry(BasePortView portView,
            BaseGraph graph = null)
        {
