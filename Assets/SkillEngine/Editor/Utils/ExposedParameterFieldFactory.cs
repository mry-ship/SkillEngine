...
namespace SkillEngine
{
    ...
    //         }
        ...
        public VisualElement GetParameterOnlyValField(ExposedParameter parameter, Action<object> valueChangedCallback)
        {
            serializedObject.Update();
            int propIndex = FindPropertyIndex(parameter);
            var field = new PropertyField(serializedParameters.GetArrayElementAtIndex(propIndex).FindPropertyRelative("val"),"");
            field.Bind(serializedObject);
